...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final RevancedLibraryAccessors laccForRevancedLibraryAccessors = new RevancedLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>smali</b> with <b>com.android.tools.smali:smali</b> coordinates and
     * with version reference <b>smali</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getSmali() {
        return create("smali");
    }

    /**
     * Dependency provider for <b>truetypeparser</b> with <b>io.github.yubyf:truetypeparser-light</b> coordinates and
     * with version reference <b>truetypeparser</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getTruetypeparser() {
        return create("truetypeparser");
    }
    ...
    /**
     * Group of libraries at <b>kotlinpoet</b>
     */
    ...
    /**
     * Group of libraries at <b>revanced</b>
     */
    public RevancedLibraryAccessors getRevanced() {
        return laccForRevancedLibraryAccessors;
    }
    ...
    public static class GradleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>gradle.plugin</b>
         */
        public GradlePluginLibraryAccessors getPlugin() {
    ...
    public static class GradlePluginLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("gradle.plugin.android");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getKotlin() {
            return create("gradle.plugin.kotlin");
        }

    }

    public static class KotlinpoetLibraryAccessors extends SubDependencyFactory {

        public KotlinpoetLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ksp</b> with <b>com.squareup:kotlinpoet-ksp</b> coordinates and
         * with version reference <b>kotlinpoet.ksp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RevancedLibraryAccessors extends SubDependencyFactory {

        public RevancedLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>patcher</b> with <b>kofua.app.revanced:revanced-patcher</b> coordinates and
         * with version reference <b>revanced.patcher</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPatcher() {
            return create("revanced.patcher");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final RevancedVersionAccessors vaccForRevancedVersionAccessors = new RevancedVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>fastjson</b> with value <b>1.2.83</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>smali</b> with value <b>3.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSmali() { return getVersion("smali"); }

        /**
         * Version alias <b>truetypeparser</b> with value <b>2.1.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTruetypeparser() { return getVersion("truetypeparser"); }
        ...
        /**
         * Group of versions at <b>versions.kotlinpoet</b>
         */
        public KotlinpoetVersionAccessors getKotlinpoet() {
        ...
        /**
         * Group of versions at <b>versions.revanced</b>
         */
        public RevancedVersionAccessors getRevanced() {
            return vaccForRevancedVersionAccessors;
        }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.annotation</b> with value <b>1.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidx.recyclerview</b> with value <b>1.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinpoetVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinpoet.ksp</b> with value <b>1.18.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKsp() { return getVersion("kotlinpoet.ksp"); }
    ...
    public static class RevancedVersionAccessors extends VersionFactory  {

        public RevancedVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>revanced.patcher</b> with value <b>19.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPatcher() { return getVersion("revanced.patcher"); }
